...
class collapsible_widget extends WP_Widget {
	...
	function __construct() {
		...
		wp_register_script( 'collapsible-widgets', plugins_url( 'scripts/collapsible-widgets.js', __FILE__ ), array(), '0.1a.11', true );
		if ( ! empty( $theme ) )
			wp_register_style( 'jquery-ui', $theme, array(), '1.8.17', 'screen' );
		wp_register_style( 'collapsible-widgets', plugins_url( 'css/collapsible-widgets.css', __FILE__ ), array( 'jquery-ui' ), '0.1a.4', true );
